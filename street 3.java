...
int FinalPort = 5002;// should be taken from db
int greents;
static int already;
	...
	public void initialise()
	{
	 ...
	 public void run() {
	        try {
	        	...
	        	addr1= new  InetSocketAddress("172.16.31.255", 9877);
	...
	class E extends Thread {
	    ...
	    public void run() {
	        try {
	    		...
	    		DatagramSocket newsocket = new DatagramSocket(9877);
	...
	void receiveEGN(){
		try {
			...
			else
			{
            	...
            	greents = Integer.parseInt(temp[4]);
